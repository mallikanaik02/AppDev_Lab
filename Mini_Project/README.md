...
## Features
- User authentication with Firebase (email/password) and Guest access
- Dynamic music recommendations via Spotify API integrating favorite artists and genres
- Recently discovered songs tracking and management
- VIP premium access with exclusive features and upsell calls-to-action
- Admin panel for user management VIP toggling, and feature flag control
- Responsive and accessible UI/UX with live artist search, genre selection, and animations
- Comprehensive Jest tests covering authentication, role gating, and core flows


---

For detailed project report and demo video, please refer to the `Mini_Project/Outputs` folder.
